...
defaultSettings = {
    ...
    "stream short failure seconds": 8,
    "stream health lookback days": 30,
    ...
    "playlist export per portal channels": True,
    "playlist export grouped channels": False,
...
defaultPortal = {
    ...
    "xtream logins": [],
    "xtream user agent": "",
    "stalker cache ttl seconds": 300,
    "stalker cache ttl min seconds": 20,
    "stalker cache ttl max seconds": 900,
    "streams per mac": 1,
    "epg offset": 0,
    "proxy": "",
    "fetch epg": True,
